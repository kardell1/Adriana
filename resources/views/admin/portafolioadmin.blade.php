...
@section('subtitle', 'PORTAFOLIO')
@section('content_header_title', 'Administrar')
@section('content_header_subtitle', 'Portafolio de la ECA')

{{-- Content body: main page content --}}

@section('content_body')
    <p>En esta seccion agrega nuevo contenido al portafolio de la Escuela de Cine y Artes Visuales .</p>
    ...
    <style>
        ...
        <label>Código del contenido (2):</label>
        <input type="text" name="cod_contenido" value="2" readonly>
